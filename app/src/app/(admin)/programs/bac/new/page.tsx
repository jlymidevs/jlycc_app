...
import { createInitiative } from "@/actions/bac";
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <h1 className="text-2xl font-bold text-gray-900 mt-1">New initiative</h1>
      </div>
      <form action={(fd) => void createInitiative(fd)} className="space-y-5">
        <div>
        ...
        <div>
          ...
          <input name="targetCommunity" type="text" className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
        ...
        <div className="flex gap-3">
          ...
          <Link href="/programs/bac" className="rounded-md border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50">
            Cancel
          </Link>
        </div>
      </form>
