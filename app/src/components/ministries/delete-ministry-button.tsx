...
export function DeleteMinistryButton({ ministryId }: { ministryId: number }) {
  ...
  return (
    <button
      ...
      onClick={() => {
        if (
          confirm(
            "Delete this ministry? This will remove its chapters and memberships. This cannot be undone."
          )
        ) {
